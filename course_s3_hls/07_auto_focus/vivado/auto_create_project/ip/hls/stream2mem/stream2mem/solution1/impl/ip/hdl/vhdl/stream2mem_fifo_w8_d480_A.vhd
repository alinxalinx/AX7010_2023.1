...
entity stream2mem_fifo_w8_d480_A is
    generic (
...
architecture arch of stream2mem_fifo_w8_d480_A is

    -- component
    component stream2mem_fifo_w8_d480_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_stream2mem_fifo_w8_d480_A_ram : stream2mem_fifo_w8_d480_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity stream2mem_fifo_w8_d480_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 8;
        ADDR_WIDTH  : integer := 9;
...
architecture arch of stream2mem_fifo_w8_d480_A_ram is

...
entity mem2stream_fifo_w32_d3840_A is
    generic (
...
architecture arch of mem2stream_fifo_w32_d3840_A is

    -- component
    component mem2stream_fifo_w32_d3840_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_mem2stream_fifo_w32_d3840_A_ram : mem2stream_fifo_w32_d3840_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity mem2stream_fifo_w32_d3840_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 12;
...
architecture arch of mem2stream_fifo_w32_d3840_A_ram is

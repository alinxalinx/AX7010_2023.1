...
entity stream2mem_AXIvideo2xfMat_24_16_1080_1920_1_2_Pipeline_loop_col_zxi2mat is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of stream2mem_AXIvideo2xfMat_24_16_1080_1920_1_2_Pipeline_loop_col_zxi2mat is 
...
attribute shreg_extract : string;
    ...
    signal j_2_fu_191_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_sig_allocacmp_j_1 : STD_LOGIC_VECTOR (10 downto 0);
    signal axi_last_3_fu_80 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    axi_last_3_fu_80_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_const_boolean_1 = ap_condition_220)) then 
                    axi_last_3_fu_80 <= vstream_TLAST;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    axi_last_3_fu_80 <= axi_last_2;
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, vstream_TVALID, ap_predicate_op35_read_state1, img_data_full_n, icmp_ln133_reg_259, ap_start_int)
    begin
                ap_block_pp0_stage0_01001 <= (((icmp_ln133_reg_259 = ap_const_lv1_0) and (img_data_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op35_read_state1 = ap_const_boolean_1) and (vstream_TVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, vstream_TVALID, ap_predicate_op35_read_state1, img_data_full_n, icmp_ln133_reg_259, ap_start_int)
    begin
                ap_block_pp0_stage0_11001 <= (((icmp_ln133_reg_259 = ap_const_lv1_0) and (img_data_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op35_read_state1 = ap_const_boolean_1) and (vstream_TVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, vstream_TVALID, ap_predicate_op35_read_state1, img_data_full_n, icmp_ln133_reg_259, ap_start_int)
    begin
                ap_block_pp0_stage0_subdone <= (((icmp_ln133_reg_259 = ap_const_lv1_0) and (img_data_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op35_read_state1 = ap_const_boolean_1) and (vstream_TVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(vstream_TVALID, ap_predicate_op35_read_state1)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_predicate_op35_read_state1 = ap_const_boolean_1) and (vstream_TVALID = ap_const_logic_0));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(img_data_full_n, icmp_ln133_reg_259)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln133_reg_259 = ap_const_lv1_0) and (img_data_full_n = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_last_phi_fu_148_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, last_reg_145, ap_loop_init, axi_last_3_fu_80, ap_condition_217)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) then
            if ((ap_loop_init = ap_const_logic_1)) then 
                ap_phi_mux_last_phi_fu_148_p4 <= ap_const_lv1_0;
            elsif ((ap_const_boolean_1 = ap_condition_217)) then 
                ap_phi_mux_last_phi_fu_148_p4 <= axi_last_3_fu_80;
            else 
    ...
    icmp_ln133_fu_185_p2 <= "1" when (ap_sig_allocacmp_j_1 = ap_const_lv11_780) else "0";

    img_data_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, img_data_full_n, icmp_ln133_reg_259, ap_block_pp0_stage0)
    begin
    ...
    img_data_din <= axi_data_fu_84;

    img_data_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln133_reg_259, ap_block_pp0_stage0_11001)
    begin
    ...
    j_2_fu_191_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_1) + unsigned(ap_const_lv11_1));
    ...
    vstream_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, vstream_TVALID, ap_predicate_op35_read_state1, ap_block_pp0_stage0, ap_start_int)
    begin
    ...
    vstream_TREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_predicate_op35_read_state1, ap_block_pp0_stage0_11001, ap_start_int)
    begin

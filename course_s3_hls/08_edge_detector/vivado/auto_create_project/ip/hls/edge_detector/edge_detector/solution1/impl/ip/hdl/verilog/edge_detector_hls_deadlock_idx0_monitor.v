...
module edge_detector_hls_deadlock_idx0_monitor ( // for module edge_detector_edge_detector_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[1] = idx1_block & (1'b0 | axis_block_sigs[1] | axis_block_sigs[2] | axis_block_sigs[0]);
...
// instant sub module
 edge_detector_hls_deadlock_idx1_monitor edge_detector_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),

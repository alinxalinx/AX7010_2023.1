...
architecture behav of edge_detector is 
    ...
    signal Block_entry1_proc_U0_ap_return : STD_LOGIC_VECTOR (7 downto 0);
    signal threshold_1_channel_full_n : STD_LOGIC;
    ...
    signal xfrgb2gray_1080_1920_U0_srcImg_data_read : STD_LOGIC;
    ...
    signal thresholding_1080_1920_U0_sobelImg_data_read : STD_LOGIC;
    signal thresholding_1080_1920_U0_thresholdImg_data_din : STD_LOGIC_VECTOR (7 downto 0);
    signal thresholding_1080_1920_U0_thresholdImg_data_write : STD_LOGIC;
    ...
    signal xfgray2rgb_1080_1920_U0_thresholdImg_data_read : STD_LOGIC;
    signal xfgray2rgb_1080_1920_U0_rgbSobel_data_din : STD_LOGIC_VECTOR (23 downto 0);
    signal xfgray2rgb_1080_1920_U0_rgbSobel_data_write : STD_LOGIC;
    ...
    signal xfMat2AXIvideo_24_16_1080_1920_1_2_U0_rgbSobel_data_read : STD_LOGIC;
    ...
    signal threshold_1_channel_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal threshold_1_channel_num_data_valid : STD_LOGIC_VECTOR (3 downto 0);
    signal threshold_1_channel_fifo_cap : STD_LOGIC_VECTOR (3 downto 0);
    signal threshold_1_channel_empty_n : STD_LOGIC;
    ...
    signal thresholdImg_data_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal thresholdImg_data_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal rgbSobel_data_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal rgbSobel_data_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component edge_detector_Block_entry1_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component edge_detector_AXIvideo2xfMat_24_16_1080_1920_1_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component edge_detector_xFSobelFilter3x3_0_0_1080_1920_1_0_0_1_2_2_2_1_1_1920_false_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        thresholdImg_data_dout : IN STD_LOGIC_VECTOR (7 downto 0);
        thresholdImg_data_num_data_valid : IN STD_LOGIC_VECTOR (1 downto 0);
        thresholdImg_data_fifo_cap : IN STD_LOGIC_VECTOR (1 downto 0);
        thresholdImg_data_empty_n : IN STD_LOGIC;
        thresholdImg_data_read : OUT STD_LOGIC;
        rgbSobel_data_din : OUT STD_LOGIC_VECTOR (23 downto 0);
        ...
        rgbSobel_data_write : OUT STD_LOGIC;
        start_out : OUT STD_LOGIC;
        start_write : OUT STD_LOGIC );
    end component;


    component edge_detector_xfMat2AXIvideo_24_16_1080_1920_1_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component edge_detector_fifo_w24_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component edge_detector_start_for_xFSobelFilter3x3_0_0_1080_1920_1_0_0_1_2_2_2_1_1_1920_false_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component edge_detector_start_for_xfMat2AXIvideo_24_16_1080_1920_1_2_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component edge_detector_control_s_axi IS
    generic (
...
begin
    control_s_axi_U : component edge_detector_control_s_axi
    generic map (
    ...
    Block_entry1_proc_U0 : component edge_detector_Block_entry1_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    AXIvideo2xfMat_24_16_1080_1920_1_2_U0 : component edge_detector_AXIvideo2xfMat_24_16_1080_1920_1_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    xFSobelFilter3x3_0_0_1080_1920_1_0_0_1_2_2_2_1_1_1920_false_U0 : component edge_detector_xFSobelFilter3x3_0_0_1080_1920_1_0_0_1_2_2_2_1_1_1920_false_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    xfMat2AXIvideo_24_16_1080_1920_1_2_U0 : component edge_detector_xfMat2AXIvideo_24_16_1080_1920_1_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    threshold_1_channel_U : component edge_detector_fifo_w8_d5_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    srcImg_data_U : component edge_detector_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    grayImg_data_U : component edge_detector_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    sobelImg_x_data_U : component edge_detector_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    sobelImg_y_data_U : component edge_detector_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    sobelImg_data_U : component edge_detector_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    thresholdImg_data_U : component edge_detector_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    rgbSobel_data_U : component edge_detector_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_xFSobelFilter3x3_0_0_1080_1920_1_0_0_1_2_2_2_1_1_1920_false_U0_U : component edge_detector_start_for_xFSobelFilter3x3_0_0_1080_1920_1_0_0_1_2_2_2_1_1_1920_false_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_xfMat2AXIvideo_24_16_1080_1920_1_2_U0_U : component edge_detector_start_for_xfMat2AXIvideo_24_16_1080_1920_1_2_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    Block_entry1_proc_U0_ap_continue <= threshold_1_channel_full_n;
    Block_entry1_proc_U0_ap_start <= ap_const_logic_1;
    ...
    thresholding_1080_1920_U0_ap_start <= threshold_1_channel_empty_n;

...
entity edge_detector_xfMat2AXIvideo_24_16_1080_1920_1_2_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of edge_detector_xfMat2AXIvideo_24_16_1080_1920_1_2_s is 
...
attribute shreg_extract : string;
    ...
    signal grp_xfMat2AXIvideo_24_16_1080_1920_1_2_Pipeline_loop_col_mat2axi_fu_76_rgbSobel_data_read : STD_LOGIC;
    ...
    component edge_detector_xfMat2AXIvideo_24_16_1080_1920_1_2_Pipeline_loop_col_mat2axi IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component edge_detector_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_xfMat2AXIvideo_24_16_1080_1920_1_2_Pipeline_loop_col_mat2axi_fu_76 : component edge_detector_xfMat2AXIvideo_24_16_1080_1920_1_2_Pipeline_loop_col_mat2axi
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        rgbSobel_data_num_data_valid => ap_const_lv2_0,
        rgbSobel_data_fifo_cap => ap_const_lv2_0,
    ...
    regslice_both_dst_V_data_V_U : component edge_detector_regslice_both
    generic map (
        DataWidth => 24)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_dst_V_keep_V_U : component edge_detector_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_dst_V_strb_V_U : component edge_detector_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_dst_V_user_V_U : component edge_detector_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_dst_V_last_V_U : component edge_detector_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_dst_V_id_V_U : component edge_detector_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_dst_V_dest_V_U : component edge_detector_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    rgbSobel_data_read_assign_proc : process(grp_xfMat2AXIvideo_24_16_1080_1920_1_2_Pipeline_loop_col_mat2axi_fu_76_rgbSobel_data_read, ap_CS_fsm_state3)
    begin

...
module edge_detector_xfMat2AXIvideo_24_16_1080_1920_1_2_Pipeline_loop_col_mat2axi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((dst_TREADY == 1'b0) & (icmp_ln199_reg_171 == 1'd0)) | ((icmp_ln199_reg_171 == 1'd0) & (rgbSobel_data_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((dst_TREADY == 1'b0) & (icmp_ln199_reg_171 == 1'd0)) | ((icmp_ln199_reg_171 == 1'd0) & (rgbSobel_data_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((dst_TREADY == 1'b0) & (icmp_ln199_reg_171 == 1'd0)) | ((icmp_ln199_reg_171 == 1'd0) & (rgbSobel_data_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((dst_TREADY == 1'b0) & (icmp_ln199_reg_171 == 1'd0)) | ((icmp_ln199_reg_171 == 1'd0) & (rgbSobel_data_empty_n == 1'b0)));
end
...
assign dst_TDATA = rgbSobel_data_dout;
...
endmodule //edge_detector_xfMat2AXIvideo_24_16_1080_1920_1_2_Pipeline_loop_col_mat2axi
